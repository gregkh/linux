...
static void Hacl_Impl_SHA3_loadState(uint32_t rateInBytes, uint8_t *input,
                                     uint64_t *s)
{
...
static const uint32_t keccak_rotc[24U] = {
        (uint32_t)1U,  (uint32_t)3U,  (uint32_t)6U,  (uint32_t)10U,
        (uint32_t)15U, (uint32_t)21U, (uint32_t)28U, (uint32_t)36U,
        (uint32_t)45U, (uint32_t)55U, (uint32_t)2U,  (uint32_t)14U,
        (uint32_t)27U, (uint32_t)41U, (uint32_t)56U, (uint32_t)8U,
        (uint32_t)25U, (uint32_t)43U, (uint32_t)62U, (uint32_t)18U,
        (uint32_t)39U, (uint32_t)61U, (uint32_t)20U, (uint32_t)44U
};

static const uint32_t keccak_piln[24U] = {
        (uint32_t)10U, (uint32_t)7U,  (uint32_t)11U, (uint32_t)17U,
        (uint32_t)18U, (uint32_t)3U,  (uint32_t)5U,  (uint32_t)16U,
        (uint32_t)8U,  (uint32_t)21U, (uint32_t)24U, (uint32_t)4U,
        (uint32_t)15U, (uint32_t)23U, (uint32_t)19U, (uint32_t)13U,
        (uint32_t)12U, (uint32_t)2U,  (uint32_t)20U, (uint32_t)14U,
        (uint32_t)22U, (uint32_t)9U,  (uint32_t)6U,  (uint32_t)1U
};

static const uint64_t keccak_rndc[24U] = {
        (uint64_t)0x0000000000000001U, (uint64_t)0x0000000000008082U,
        (uint64_t)0x800000000000808aU, (uint64_t)0x8000000080008000U,
        (uint64_t)0x000000000000808bU, (uint64_t)0x0000000080000001U,
        (uint64_t)0x8000000080008081U, (uint64_t)0x8000000000008009U,
        (uint64_t)0x000000000000008aU, (uint64_t)0x0000000000000088U,
        (uint64_t)0x0000000080008009U, (uint64_t)0x000000008000000aU,
        (uint64_t)0x000000008000808bU, (uint64_t)0x800000000000008bU,
        (uint64_t)0x8000000000008089U, (uint64_t)0x8000000000008003U,
        (uint64_t)0x8000000000008002U, (uint64_t)0x8000000000000080U,
        (uint64_t)0x000000000000800aU, (uint64_t)0x800000008000000aU,
        (uint64_t)0x8000000080008081U, (uint64_t)0x8000000000008080U,
        (uint64_t)0x0000000080000001U, (uint64_t)0x8000000080008008U
};

static void Hacl_Impl_SHA3_state_permute(uint64_t *s)
{
        for (uint32_t i0 = (uint32_t)0U; i0 < (uint32_t)24U; i0++) {
                uint64_t _C[5U] = { 0U };
                KRML_MAYBE_FOR5(i, (uint32_t)0U, (uint32_t)5U, (uint32_t)1U,
                                _C[i] = s[i + (uint32_t)0U] ^
                                        (s[i + (uint32_t)5U] ^
                                         (s[i + (uint32_t)10U] ^
                                          (s[i + (uint32_t)15U] ^
                                           s[i + (uint32_t)20U]))););
                KRML_MAYBE_FOR5(
                        i1, (uint32_t)0U, (uint32_t)5U, (uint32_t)1U,
                        uint64_t uu____0 =
                                _C[(i1 + (uint32_t)1U) % (uint32_t)5U];
                        uint64_t _D = _C[(i1 + (uint32_t)4U) % (uint32_t)5U] ^
                                      (uu____0 << (uint32_t)1U |
                                       uu____0 >> (uint32_t)63U);
                        KRML_MAYBE_FOR5(
                                i, (uint32_t)0U, (uint32_t)5U, (uint32_t)1U,
                                s[i1 + (uint32_t)5U * i] =
                                        s[i1 + (uint32_t)5U * i] ^ _D;););
                uint64_t x = s[1U];
                uint64_t curr = x;
                for (uint32_t i = (uint32_t)0U; i < (uint32_t)24U; i++) {
                        ...
                        uint64_t temp = s[_Y];
                        uint64_t uu____1 = curr;
                        s[_Y] = uu____1 << r | uu____1 >> ((uint32_t)64U - r);
                        curr = temp;
                }
                KRML_MAYBE_FOR5(
                        i, (uint32_t)0U, (uint32_t)5U, (uint32_t)1U,
                        uint64_t v0 = s[(uint32_t)0U + (uint32_t)5U * i] ^
                                      (~s[(uint32_t)1U + (uint32_t)5U * i] &
                                       s[(uint32_t)2U + (uint32_t)5U * i]);
                        uint64_t v1 = s[(uint32_t)1U + (uint32_t)5U * i] ^
                                      (~s[(uint32_t)2U + (uint32_t)5U * i] &
                                       s[(uint32_t)3U + (uint32_t)5U * i]);
                        uint64_t v2 = s[(uint32_t)2U + (uint32_t)5U * i] ^
                                      (~s[(uint32_t)3U + (uint32_t)5U * i] &
                                       s[(uint32_t)4U + (uint32_t)5U * i]);
                        uint64_t v3 = s[(uint32_t)3U + (uint32_t)5U * i] ^
                                      (~s[(uint32_t)4U + (uint32_t)5U * i] &
                                       s[(uint32_t)0U + (uint32_t)5U * i]);
                        uint64_t v4 = s[(uint32_t)4U + (uint32_t)5U * i] ^
                                      (~s[(uint32_t)0U + (uint32_t)5U * i] &
                                       s[(uint32_t)1U + (uint32_t)5U * i]);
...
static void Hacl_Impl_SHA3_absorb_inner(uint32_t rateInBytes, uint8_t *block,
                                        uint64_t *s)
{
...
static void absorb(uint64_t *s, uint32_t rateInBytes, uint32_t inputByteLen,
                   uint8_t *input, uint8_t delimitedSuffix)
{
        ...
        if (!((delimitedSuffix & (uint8_t)0x80U) == (uint8_t)0U) &&
            rem == rateInBytes - (uint32_t)1U) {
                Hacl_Impl_SHA3_state_permute(s);
        }
...
static void Hacl_Hash_SHA3_update_multi_sha3(Spec_Hash_Definitions_hash_alg a,
                                             uint64_t *s, uint8_t *blocks,
                                             uint32_t n_blocks)
{
        for (uint32_t i = (uint32_t)0U; i < n_blocks; i++) {
...
static void Hacl_Hash_SHA3_update_last_sha3(Spec_Hash_Definitions_hash_alg a,
                                            uint64_t *s, uint8_t *input,
                                            uint32_t input_len)
{
        uint8_t suffix;
        if (a == Spec_Hash_Definitions_Shake128 ||
            a == Spec_Hash_Definitions_Shake256) {
        ...
        if (input_len == len) {
                ...
                if (!((suffix & (uint8_t)0x80U) == (uint8_t)0U) &&
                    (uint32_t)0U == len - (uint32_t)1U) {
                        Hacl_Impl_SHA3_state_permute(s);
                }
                uint8_t nextBlock_[200U] = { 0U };
                uint8_t *nextBlock = nextBlock_;
...
{
        struct Hacl_Streaming_Keccak_state_s scrut = *s;
        struct Hacl_Streaming_Keccak_hash_buf_s block_state = scrut.block_state;
        return block_state.fst;
}

void Hacl_Streaming_Keccak_reset(struct Hacl_Streaming_Keccak_state_s *s)
{
        struct Hacl_Streaming_Keccak_state_s scrut = *s;
        ...
        struct Hacl_Streaming_Keccak_state_s tmp = {
...
{
        struct Hacl_Streaming_Keccak_state_s s = *p;
        struct Hacl_Streaming_Keccak_hash_buf_s block_state = s.block_state;
        ...
        uint32_t sz;
        if (total_len % (uint64_t)block_len(i) == (uint64_t)0U &&
        ...
        if (len <= block_len(i) - sz) {
                struct Hacl_Streaming_Keccak_state_s s1 = *p;
                struct Hacl_Streaming_Keccak_hash_buf_s block_state1 =
                        s1.block_state;
                uint8_t *buf = s1.buf;
                uint64_t total_len1 = s1.total_len;
                uint32_t sz1;
                if (total_len1 % (uint64_t)block_len(i) == (uint64_t)0U &&
                ...
                *p = ((struct Hacl_Streaming_Keccak_state_s){
                ...
                if (!(sz1 == (uint32_t)0U)) {
                        ...
                        Hacl_Hash_SHA3_update_multi_sha3(
                                a1, s2, buf, block_len(i) / block_len(a1));
                }
                uint32_t ite;
                if ((uint64_t)len % (uint64_t)block_len(i) == (uint64_t)0U &&
                    (uint64_t)len > (uint64_t)0U) {
                        ite = block_len(i);
                } else {
                        ite = (uint32_t)((uint64_t)len %
                ...
                Spec_Hash_Definitions_hash_alg a1 = block_state1.fst;
                uint64_t *s2 = block_state1.snd;
                Hacl_Hash_SHA3_update_multi_sha3(a1, s2, data1,
                                                 data1_len / block_len(a1));
                uint8_t *dst = buf;
                ...
                *p = ((struct Hacl_Streaming_Keccak_state_s){
                ...
                struct Hacl_Streaming_Keccak_state_s s1 = *p;
                struct Hacl_Streaming_Keccak_hash_buf_s block_state10 =
                        s1.block_state;
                uint8_t *buf0 = s1.buf;
                uint64_t total_len10 = s1.total_len;
                uint32_t sz10;
                if (total_len10 % (uint64_t)block_len(i) == (uint64_t)0U &&
                ...
                *p = ((struct Hacl_Streaming_Keccak_state_s){
                        ...
                        .buf = buf0,
                        .total_len = total_len2 });
                struct Hacl_Streaming_Keccak_state_s s10 = *p;
                struct Hacl_Streaming_Keccak_hash_buf_s block_state1 =
                        s10.block_state;
                uint8_t *buf = s10.buf;
                ...
                uint32_t ite;
                if ((uint64_t)(len - diff) % (uint64_t)block_len(i) ==
                            (uint64_t)0U &&
                    (uint64_t)(len - diff) > (uint64_t)0U) {
                        ite = block_len(i);
                } else {
                        ite = (uint32_t)((uint64_t)(len - diff) %
                                         (uint64_t)block_len(i));
                }
                ...
                Spec_Hash_Definitions_hash_alg a1 = block_state1.fst;
                uint64_t *s2 = block_state1.snd;
                Hacl_Hash_SHA3_update_multi_sha3(a1, s2, data11,
                                                 data1_len / block_len(a1));
                uint8_t *dst = buf;
...
static void Hacl_Impl_SHA3_squeeze(uint64_t *s, uint32_t rateInBytes,
...
static void finish_(Spec_Hash_Definitions_hash_alg a,
                    struct Hacl_Streaming_Keccak_state_s *p, uint8_t *dst,
                    uint32_t l)
{
        struct Hacl_Streaming_Keccak_state_s scrut0 = *p;
        struct Hacl_Streaming_Keccak_hash_buf_s block_state =
                scrut0.block_state;
        uint8_t *buf_ = scrut0.buf;
        uint64_t total_len = scrut0.total_len;
        uint32_t r;
        if (total_len % (uint64_t)block_len(a) == (uint64_t)0U &&
            total_len > (uint64_t)0U) {
                r = block_len(a);
        } else {
        ...
        Hacl_Hash_SHA3_update_multi_sha3(a1, s0, buf_multi,
                                         (uint32_t)0U / block_len(a1));
...
Hacl_Streaming_Types_error_code
Hacl_Streaming_Keccak_finish(struct Hacl_Streaming_Keccak_state_s *s,
                             uint8_t *dst)
{
        Spec_Hash_Definitions_hash_alg a1 = Hacl_Streaming_Keccak_get_alg(s);
        if (a1 == Spec_Hash_Definitions_Shake128 ||
...
Hacl_Streaming_Types_error_code
Hacl_Streaming_Keccak_squeeze(struct Hacl_Streaming_Keccak_state_s *s,
                              uint8_t *dst, uint32_t l)
{
        Spec_Hash_Definitions_hash_alg a1 = Hacl_Streaming_Keccak_get_alg(s);
        if (!(a1 == Spec_Hash_Definitions_Shake128 ||
              a1 == Spec_Hash_Definitions_Shake256)) {
...
static void Hacl_Impl_SHA3_keccak(uint32_t rate, uint32_t capacity,
...
void Hacl_SHA3_shake128_hacl(uint32_t inputByteLen, uint8_t *input,
                             uint32_t outputByteLen, uint8_t *output)
{
        Hacl_Impl_SHA3_keccak((uint32_t)1344U, (uint32_t)256U, inputByteLen,
                              input, (uint8_t)0x1FU, outputByteLen, output);
}

void Hacl_SHA3_shake256_hacl(uint32_t inputByteLen, uint8_t *input,
                             uint32_t outputByteLen, uint8_t *output)
{
        Hacl_Impl_SHA3_keccak((uint32_t)1088U, (uint32_t)512U, inputByteLen,
                              input, (uint8_t)0x1FU, outputByteLen, output);
}

void Hacl_SHA3_sha3_224(uint32_t inputByteLen, uint8_t *input, uint8_t *output)
{
        Hacl_Impl_SHA3_keccak((uint32_t)1152U, (uint32_t)448U, inputByteLen,
                              input, (uint8_t)0x06U, (uint32_t)28U, output);
}

void Hacl_SHA3_sha3_256(uint32_t inputByteLen, uint8_t *input, uint8_t *output)
{
        Hacl_Impl_SHA3_keccak((uint32_t)1088U, (uint32_t)512U, inputByteLen,
                              input, (uint8_t)0x06U, (uint32_t)32U, output);
}

void Hacl_SHA3_sha3_384(uint32_t inputByteLen, uint8_t *input, uint8_t *output)
{
        Hacl_Impl_SHA3_keccak((uint32_t)832U, (uint32_t)768U, inputByteLen,
                              input, (uint8_t)0x06U, (uint32_t)48U, output);
}
